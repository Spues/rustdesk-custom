...
class ColorThemeExtension extends ThemeExtension<ColorThemeExtension> {
  ...
  static final light = ColorThemeExtension(
    border: Color(0xFF4CAF50),        // 主色绿
    border2: Color(0xFF81C784),       // 浅绿
    border3: Color(0xFFA5D6A7),       // 淡绿
    highlight: Color(0xFFE8F5E9),     // 极淡绿背景
    drag_indicator: Color(0xFF2E7D32), // 深绿
    shadow: Colors.black54,
    errorBannerBg: Color(0xFFFFEBEE),
    me: Color(0xFF2196F3),            // 蓝色强调
    toastBg: Colors.black.withOpacity(0.7),
  ...
  static final dark = ColorThemeExtension(
    border: Color(0xFF4CAF50),          // 主色绿
    border2: Color(0xFF81C784),         // 浅绿
    border3: Color(0xFF1B5E20),         // 深绿边框
    highlight: Color(0xFF2E7D32),       // 高亮绿
    drag_indicator: Color(0xFFA5D6A7),  // 淡绿指示器
    shadow: Colors.black54,
    errorBannerBg: Color(0xFF470F2D),
    me: Color(0xFF64B5F6),              // 亮蓝强调
    toastBg: Colors.white.withOpacity(0.7),
...
class MyTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    primaryColor: Color(0xFF4CAF50),  // 主色绿
    colorScheme: ColorScheme.light(
      primary: Color(0xFF4CAF50),
      secondary: Color(0xFF2196F3),
      surface: Colors.white,
    ),
    hoverColor: Color.fromARGB(255, 232, 245, 233),  // 淡绿hover
    scaffoldBackgroundColor: Color(0xFFFAFAFA),  // 轻微灰白背景
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    hoverColor: Color.fromARGB(255, 46, 125, 50),  // 深绿hover
